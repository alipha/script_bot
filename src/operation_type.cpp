...
//  symbol  bin?  ops    associativity   prec  nop?       category                code                  replace_with    left_pair?     primary_right         other_right
    ...
    {">=",  true,  2, associative::left,  450, false, op_category::comparison, op_code::gte,          op_code::none,         false, op_code::none,         op_code::none},
    {"==",  true,  2, associative::left,  450, false, op_category::comparison, op_code::eq,           op_code::none,         false, op_code::none,         op_code::none},
    {"!=",  true,  2, associative::left,  450, false, op_category::comparison, op_code::neq,          op_code::none,         false, op_code::none,         op_code::none},
    {"%",   true,  2, associative::left,  550, false, op_category::integer,    op_code::mod,          op_code::none,         false, op_code::none,         op_code::none},
    {"&",   true,  2, associative::left,  375, false, op_category::integer,    op_code::bit_and,      op_code::none,         false, op_code::none,         op_code::none},
    {"^",   true,  2, associative::left,  350, false, op_category::integer,    op_code::bit_xor,      op_code::none,         false, op_code::none,         op_code::none},
    {"|",   true,  2, associative::left,  325, false, op_category::integer,    op_code::bit_or,       op_code::none,         false, op_code::none,         op_code::none},
    {"<<",  true,  2, associative::left,  475, false, op_category::integer,    op_code::shl,          op_code::none,         false, op_code::none,         op_code::none},
    {">>",  true,  2, associative::left,  475, false, op_category::integer,    op_code::shr,          op_code::none,         false, op_code::none,         op_code::none},
    {"**",  true,  2, associative::left,  575, false, op_category::arithmetic, op_code::pow,          op_code::none,         false, op_code::none,         op_code::none},
    {"+",   true,  2, associative::left,  500, false, op_category::arithmetic, op_code::add,          op_code::none,         false, op_code::none,         op_code::none},
    {"-",   true,  2, associative::left,  500, false, op_category::arithmetic, op_code::sub,          op_code::none,         false, op_code::none,         op_code::none},
    {"*",   true,  2, associative::left,  550, false, op_category::arithmetic, op_code::mul,          op_code::none,         false, op_code::none,         op_code::none},
    {"/",   true,  2, associative::left,  550, false, op_category::arithmetic, op_code::div,          op_code::none,         false, op_code::none,         op_code::none},
    {"=",   true,  2, associative::right, 200, false, op_category::assignment, op_code::assign,       op_code::none,         false, op_code::none,         op_code::none},
    {"%=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::mod_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"&=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::and_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"^=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::xor_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"|=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::or_assign,    op_code::none,         false, op_code::none,         op_code::none},
    {"<<=", true,  2, associative::right, 200, false, op_category::assignment, op_code::shl_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {">>=", true,  2, associative::right, 200, false, op_category::assignment, op_code::shr_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"**=", true,  2, associative::right, 200, false, op_category::assignment, op_code::pow_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"+=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::add_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"-=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::sub_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"*=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::mul_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"/=",  true,  2, associative::right, 200, false, op_category::assignment, op_code::div_assign,   op_code::none,         false, op_code::none,         op_code::none},
    {"++",  false, 1, associative::right, 600, false, op_category::assignment, op_code::pre_inc,      op_code::none,         false, op_code::none,         op_code::none},
    {"--",  false, 1, associative::right, 600, false, op_category::assignment, op_code::pre_dec,      op_code::none,         false, op_code::none,         op_code::none},
    {"++",  true,  1, associative::left,  700, false, op_category::assignment, op_code::post_inc,     op_code::none,         false, op_code::none,         op_code::none},
    {"--",  true,  1, associative::left,  700, false, op_category::assignment, op_code::post_dec,     op_code::none,         false, op_code::none,         op_code::none},
    {"~",   false, 1, associative::right, 600, false, op_category::integer,    op_code::bit_not,      op_code::none,         false, op_code::none,         op_code::none},
    {"!",   false, 1, associative::right, 600, false, op_category::comparison, op_code::logic_not,    op_code::none,         false, op_code::none,         op_code::none},
    {"+",   false, 1, associative::right, 600, false, op_category::integer,    op_code::plus,         op_code::none,         false, op_code::none,         op_code::none},
    {"-",   false, 1, associative::right, 600, false, op_category::arithmetic, op_code::negate,       op_code::none,         false, op_code::none,         op_code::none},
    {"&&",  true,  1, associative::left,  300, false, op_category::comparison, op_code::logic_and,    op_code::logic_and_end,false, op_code::none,         op_code::none},
